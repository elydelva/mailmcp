...
2. release-please maintains a **"Release PR"** that bumps `package.json` version and updates `CHANGELOG.md`.
3. Merging the Release PR creates the GitHub Release and the Git tag.
4. The tag triggers the `release-please.yml` docker job which publishes to `ghcr.io`.
